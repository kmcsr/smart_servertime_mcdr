...
BIG_BLOCK_BEFOR: MCDR.RText = MCDR.RText('------------ {0} v{1} ::::', color=MCDR.RColor.aqua)
BIG_BLOCK_AFTER: MCDR.RText = MCDR.RText(':::: {0} v{1} ============', color=MCDR.RColor.aqua)
...
def init(server: MCDR.PluginServerInterface):
	...
	BIG_BLOCK_BEFOR = MCDR.RText('------------ {0} v{1} ::::'.format(metadata.name, metadata.version), color=MCDR.RColor.aqua)
	BIG_BLOCK_AFTER = MCDR.RText(':::: {0} v{1} ============'.format(metadata.name, metadata.version), color=MCDR.RColor.aqua)
